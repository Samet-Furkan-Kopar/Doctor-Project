...
const TableData = ({ sorting, searchKey, page, popupStatus, setPopupStatus, setTotalPages }) => {
  ...
  const getAllLinks = async () => {
    ...
    const res = advertServices
      .getVIPLinkList(sorting, page, searchKey)
      .then((res) => {
  ...
  return (
    <>
                      ...
                      onClick={() => {
                        Swal.fire({
                          ...
                          if (result.isConfirmed) {
                            await advertServices.deleteVIPLink(item?._id);
                            getAllLinks();
                            Swal.fire({
                              title: "Başarılı!",
      ...
      {popupStatus && <AssignmetPopup  status={popupStatus} setStatus={setPopupStatus} reloadAdvertList={getAllLinks} />}
    </>
  );
};
