...
const themeConfigSlice = createSlice({
    ...
    reducers: {
        ...
        toggleMeetingData(state, { payload }) {
            state.meetingData = payload;
        },
    },
});

export const { toggleTheme, toggleMenu, toggleLayout, toggleRTL, toggleAnimation, toggleNavbar, toggleSemidark, toggleLocale, toggleSidebar, setPageTitle, toggleMeetingData } = themeConfigSlice.actions;
