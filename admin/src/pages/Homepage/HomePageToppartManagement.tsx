...
const HomePageToppartManagement = () => {
    ...
    const SubmittedForm = Yup.object().shape({
        title: Yup.string().required('Lütfen Bölüm Başlık Metnini Giriniz'),
    ...
    useEffect(() => {
        pagecontentServices.getPageDetail('homepage', 'toppart').then((res: any) => {
                    ...
                    <div className="flex flex-col sm:flex-row">
                        <div className="flex-1 grid grid-cols-1 sm:grid-cols-1 gap-5">
                            <Form className="space-y-5">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 space-y-5">
                                    <div className="flex flex-col sm:flex-row">
                                        <div className="ltr:sm:mr-4 rtl:sm:ml-4 w-full sm:w-2/12">
                                        ...
                                        <div className={submitCount ? (errors.image ? 'has-error' : 'has-success') : ''}>
                                            <label htmlFor="image">Karşılama Resmi </label>
                                    ...
                                    <div className={submitCount ? (errors.imageAltText ? 'has-error' : 'has-success') : ''} style={{ marginTop: 0 }}>
                                        <label htmlFor="imageAltText"> Resim Alt Text </label>
...
export default HomePageToppartManagement;
