...
const HomePageBlogManagement = () => {
    ...
    useEffect(() => {
        pagecontentServices.getPageDetail('homepage', 'blogpart').then((res: any) => {
...
export default HomePageBlogManagement;
