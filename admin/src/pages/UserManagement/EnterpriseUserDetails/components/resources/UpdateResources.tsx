...
const UpdateUser = (props: any) => {
    ...
    useEffect(() => {
        if (props.targetUser && props.updateModal) {
            ...
            projectServices.getSubEnterpriseResourceDetail(props.targetUser._id).then((res: any) => {
                                ...
                                <div className="border border-[#ebedf2] dark:border-[#191e3a] rounded-md p-4 mb-5 bg-white dark:bg-black">
                                    ...
                                    <Formik
                                        initialValues={{
                                            ...
                                            status: Object.keys(userInfo).length > 0 && userInfo?.status ? statusOpt.find((c: any) => c.value == userInfo?.status) : { label: 'TR', value: "TR" },
                                        }}
