...
import AddNewUser from './AddNewTool';
import UpdateUser from './UpdateTool';

const Tools = (props: any) => {//sayfa render oluyo detaya girince
    ...
    const reloadEnterpriseUserList = () => {
        ...
        projectServices.getSubEnterpriseToolList(page, pageSize, search, props.officeId)
            .then((res) => {
    ...
    const destroyTargetUser = async (id: string) => {
        Swal.fire({
            ...
            if (result.value) {
                await projectServices.deleteTool(id).then((res) => {
    ...
    return (
        <div className="panel">
            <div className="flex md:items-center md:flex-row flex-col mb-5 gap-5">
                <h5 className="font-semibold text-lg dark:text-white-light">Araç Listesi</h5>
                <div>
