...
const RegisterPageManagement = () => {
    ...
    useEffect(() => {
        pagecontentServices.getPageDetail('register', 'page').then((res: any) => {
    ...
    return (
        <div className="border border-[#ebedf2] dark:border-[#191e3a] rounded-md p-4 mb-5 bg-white dark:bg-black">
            ...
            <Formik
                initialValues={{
                    form_title: Object.keys(pageDetail).length > 0 && pageDetail?.form_title ? pageDetail.form_title : '',
                    form_short_description: Object.keys(pageDetail).length > 0 && pageDetail?.form_short_description ? `${pageDetail.form_short_description}` : '',
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 space-y-5">
                                    <div className="flex flex-col sm:flex-row">
                                        ...
                                        <div className={submitCount ? (errors.image ? 'has-error' : 'has-success') : ''}>
                                            <label htmlFor="image">Breadcrumb Resim </label>
                                    ...
                                    <div className={submitCount ? (errors.imageAltText ? 'has-error' : 'has-success') : ''}>
                                        <label htmlFor="imageAltText">Breadcrumb Resim Alt Text </label>
...
export default RegisterPageManagement;
